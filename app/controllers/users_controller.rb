class UsersController < ApplicationController
  ...
  def destroy
    ...
    @user.destroy
    flash[:danger] = "User and all their articles has been deleted"
  ...
  def require_same_user
    if current_user != @user and !current_user.admin? #current_user.admin means if the current user is not an admin
